...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_payment_terms_create(ctx, data, dry_run, extra_params):
    """Create payment term"""
    from pland_cli._codegen.runtime import run_operation
    run_operation(
...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_payment_terms_delete(ctx, id, dry_run, extra_params):
    """Delete payment term"""
    from pland_cli._codegen.runtime import run_operation
    run_operation(
...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_payment_terms_update(ctx, id, data, dry_run, extra_params):
    """Update payment term"""
    from pland_cli._codegen.runtime import run_operation
    run_operation(
