...
@click.pass_context
def _cmd_sms_callback(ctx, data, dry_run, assume_yes, confirm_token, extra_params):
    """SMS status callback"""
...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_sms_track_clicked_link(ctx, data, dry_run, assume_yes, confirm_token, extra_params):
