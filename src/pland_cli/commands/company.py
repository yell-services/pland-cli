...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_company_consent_to_bank_integration(ctx, dry_run, assume_yes, confirm_token, extra_params):
...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_company_set_logo(ctx, data, dry_run, assume_yes, confirm_token, extra_params):
    """Set company logo"""
    from pland_cli._codegen.runtime import run_operation
    run_operation(
