...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_surcharges_create(ctx, data, dry_run, extra_params):
    """Create surcharge"""
    from pland_cli._codegen.runtime import run_operation
    run_operation(
...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_surcharges_delete(ctx, id, dry_run, extra_params):
    """Delete surcharge"""
    from pland_cli._codegen.runtime import run_operation
    run_operation(
...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_surcharges_update(ctx, id, data, dry_run, extra_params):
    """Update surcharge"""
    from pland_cli._codegen.runtime import run_operation
    run_operation(
