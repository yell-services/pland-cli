...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_holiday_create(ctx, data, dry_run, extra_params):
    """Create holiday"""
    from pland_cli._codegen.runtime import run_operation
    run_operation(
...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_holiday_delete(ctx, id, dry_run, extra_params):
    """Delete holiday"""
    from pland_cli._codegen.runtime import run_operation
    run_operation(
...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_holiday_update(ctx, id, data, dry_run, extra_params):
    """Update holiday"""
    from pland_cli._codegen.runtime import run_operation
    run_operation(
...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_holiday_import_(ctx, data, dry_run, extra_params):
    """Import holidays"""
    from pland_cli._codegen.runtime import run_operation
    run_operation(
