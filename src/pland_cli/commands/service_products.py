...
@click.group("service-products")
def service_products_group():
    """service-products-Operationen."""
    pass

@service_products_group.command("list")
...
def _cmd_service_products_list(ctx, limit, offset, sort, fetch_all, extra_params):
    ...
    run_operation(
        ctx, method='get', path="/serviceProducts/",
...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_service_products_create(ctx, data, dry_run, assume_yes, confirm_token, extra_params):
    """Create a new service product"""
    from pland_cli._codegen.runtime import run_operation
    run_operation(
        ctx, method='post', path="/serviceProducts/",
...
def _cmd_service_products_get_last_number(ctx, fetch_all, extra_params):
    ...
    from pland_cli._codegen.runtime import run_operation
    run_operation(
        ctx, method='get', path="/serviceProducts/lastNumber",
...
def _cmd_service_products_count(ctx, fetch_all, extra_params):
    ...
    from pland_cli._codegen.runtime import run_operation
    run_operation(
        ctx, method='get', path="/serviceProducts/count",
        query={}, extra_params=extra_params, fetch_all=fetch_all,
        data=None, file_=None, output=None, dry_run=False,
        risk="free", draftable=None, assume_yes=False,
        confirm_token=None,
...
def _cmd_service_products_get_distinct_values(ctx, fieldKey, fetch_all, extra_params):
    ...
    from pland_cli._codegen.runtime import run_operation
    run_operation(
        ctx, method='get', path="/serviceProducts/distinctValues",
...
def _cmd_service_products_get(ctx, id, extra_params):
    ...
    from pland_cli._codegen.runtime import run_operation
    run_operation(
        ctx, method='get', path="/serviceProducts/" + id + "",
        query={}, extra_params=extra_params, fetch_all=False,
        data=None, file_=None, output=None, dry_run=False,
        risk="free", draftable=None, assume_yes=False,
        confirm_token=None,
...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_service_products_delete(ctx, id, dry_run, assume_yes, confirm_token, extra_params):
    """Delete service product"""
    from pland_cli._codegen.runtime import run_operation
    run_operation(
        ctx, method='delete', path="/serviceProducts/" + id + "",
        query={}, extra_params=extra_params, fetch_all=False,
...
@click.option("--extra-params", default=None, help="Additional query params as JSON.")
@click.pass_context
def _cmd_service_products_update(ctx, id, data, dry_run, assume_yes, confirm_token, extra_params):
    """Update service product"""
    from pland_cli._codegen.runtime import run_operation
    run_operation(
        ctx, method='patch', path="/serviceProducts/" + id + "",
        query={}, extra_params=extra_params, fetch_all=False,
        data=data, file_=None, output=None, dry_run=dry_run,
        risk="free", draftable=None, assume_yes=assume_yes,
        confirm_token=confirm_token,
...
def register(root):
    root.add_command(service_products_group)
